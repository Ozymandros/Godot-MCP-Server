...
public interface IGodotFileService
{
    ...
    /// </summary>
    /// <param name="path">Directory path in <c>res://</c> format.</param>
    void EnsureDirectory(string path);

    /// <summary>
    /// Checks whether a file exists.
    /// </summary>
    /// <param name="path">File path in <c>res://</c> format.</param>
    ...
    /// </summary>
    /// <param name="directory">Directory path in <c>res://</c> format.</param>
